...
public class TeamNameServiceImpl implements TeamNameService {
    ...
    public TeamName save(TeamName teamName) {return teamNameRepository.save(teamName);}
    public List<TeamName> findAll() {return teamNameRepository.findAll();}
    public TeamName findById(int id) {return teamNameRepository.findById(id);}
    public void deleteById(int id) { teamNameRepository.deleteById(id);
    }
}
